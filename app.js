...
const beatsvibeDatabase = {
    ...
    "BV-1004": { password: "admin@1", name: "Suraj Gulab Rathod", courses: ["Data Analytics Pro"] },
    "BV-1005": { password: "adi@1", name: "Adarsh Gokul Chavhan", courses: ["Data Analytics Pro"] }
};
